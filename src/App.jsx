      ...
      <Router>
        <Routes>
            ...
            <div className="flex flex-col min-h-screen">
              ...
              <main className="flex-1 container mx-auto py-12 px-4">
                <div className="max-w-3xl mx-auto text-center space-y-8">
                  <h2 className="text-4xl font-bold tracking-tight">Welcome to our E-Commerce Platform</h2>
                  <p className="text-xl text-muted-foreground">Choose which interface you want to access</p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
                    <Link to="/shop" className="flex-1 max-w-xs mx-auto sm:mx-0">
                      <Button size="lg" className="w-full h-32 text-lg" variant="default">
                    ...
                    <Link to="/admin" className="flex-1 max-w-xs mx-auto sm:mx-0">
                      <Button size="lg" className="w-full h-32 text-lg" variant="outline">
                        <div className="flex flex-col items-center gap-2">
          ...
          <Route element={<ShopLayout />}>
            ...
            <Route path="/shop/categories/:id" element={<ShopCategoryDetail />} />
            ...
            <Route path="/shop/account/orders/:id" element={<ShopOrderDetail />} />
            <Route path="/shop/account/profile" element={<ShopProfile />} />
            <Route path="/shop/account/addresses" element={<ShopAddresses />} />
